...
let widgetPreviewTeam = BSMTeam(id: 999, name: "Skylarks", short_name: "BEA", league_entries: [BSMTeam.LeagueEntry(id: 0, league: widgetPreviewLeague)], current_player_list: BSMTeam.PlayerList(player_list_entries: []))
